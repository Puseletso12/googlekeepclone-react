...
const Navbar = () => {
    return(
        ...
        <div className="logo-area">
            ...
            <img className="gb_Kc gb_Kd" src="https://www.gstatic.com/images/branding/product/1x/keep_2020q4_48dp.png" alt="" aria-hidden="true" />
        ...
        <div className="settings-area">
            <div className="tooltip">
                ...
                <span className="tooltip-text">Referesh</span>
            </div>
            <div className="tooltip">
